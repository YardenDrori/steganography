        ...
        for k_y in 0..4 {
            ...
            for i_x in 0..4 {
                for i_y in 0..4 {
                    ...
                    sum += curr_pixel
                        * ((k_x as f64 * ((2f64 * i_x as f64 + 1f64) * PI / 8f64)).cos()
                            * (k_y as f64 * ((2f64 * i_y as f64 + 1f64) * PI / 8f64)).cos());
                }
            }
        ...
        for i_y in 0..4 {
            ...
            for k_x in 0..4 {
                for k_y in 0..4 {
                    ...
                    let scale_x = if k_x == 0 { 0.25f64 } else { 0.5f64 };
                    let scale_y = if k_y == 0 { 0.25f64 } else { 0.5f64 };
                    sum += curr_coefficient
                        * ((scale_x
                            * (k_x as f64 * ((2f64 * i_x as f64 + 1f64) * PI / 8f64)).cos())
                            * (scale_y
                                * (k_y as f64 * ((2f64 * i_y as f64 + 1f64) * PI / 8f64)).cos()));
