...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.90.0 (1159e78c4 2025-09-14) (Arch Linux rust 1:1.90.0-3)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.90.0 (1159e78c4 2025-09-14) (Arch Linux rust 1:1.90.0-3)";
